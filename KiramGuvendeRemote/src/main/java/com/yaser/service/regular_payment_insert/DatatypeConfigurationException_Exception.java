 ...
 * 
 */
@WebFault(name = "DatatypeConfigurationException", targetNamespace = "http://intf.service.web.api.cca.hmn.ykb.com/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: com.yaser.service.regular_payment_insert.DatatypeConfigurationException
     */
